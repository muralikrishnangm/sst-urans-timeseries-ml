...
do
  ...
  do
    ...
    srun -N 1 -n 1 -c 1 python nnTesting_apriori.py --casenum 13 --casenum_test 13 --target_T 1.0 --seq_len_T ${seq_len[$j]} --normEnergy --interpIO --set_dt_seq --dt_T ${dt_T[$i]} --nepoch 4000 --batch_size ${batch_size[$j]} --eval_regime training --saveData --HDdir $work_dir --disable_cuda &
    counter=$(($counter + 1))
